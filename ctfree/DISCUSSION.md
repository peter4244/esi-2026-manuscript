...
**[v15 ¶82, rewritten for the reframe]**

MD-COPD improves on the fixed ratio by correcting it in two groups: it
withholds a COPD diagnosis from participants with airflow limitation and no
other abnormality, and gives one to participants with preserved spirometry and
a high symptom burden. We asked whether those corrections survive when chest CT
is unavailable. Removing the CT criteria without replacing them does not
preserve them. It moves 833 participants out of COPD-major, and the category
that receives them is no longer low risk. Replacing the CT criteria with an ESI
criterion keeps the loss to 350 and keeps the categories carrying the risk their
names imply.
