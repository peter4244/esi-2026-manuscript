"""Supplemental Table S7: Cancer cause-specific mortality by MD-COPD category."""
from tables import docx_helpers as dh
from tables.supp._cause_specific_common import HEADERS, COL_WIDTHS, build_rows

TABLE_NUM = "S7"
TITLE = ("Cancer-specific mortality by MD-COPD diagnostic category under both frameworks")
