"""Supplementary Table S3b — sensitivity: alternative 4-criterion framework
replacing only the emphysema criterion."""
from tables import docx_helpers as dh
from tables.supp._s3_sensitivity_common import HEADERS, COL_WIDTHS, build_rows

TABLE_NUM = "S3b"
TITLE = ("Sensitivity analysis: category-level associations under the "
         "alternative 4-criterion framework (emphysema criterion replaced)")
