"""Supplemental Table S6: Cardiovascular disease cause-specific mortality by MD-COPD category."""
from tables import docx_helpers as dh
from tables.supp._cause_specific_common import HEADERS, COL_WIDTHS, build_rows

TABLE_NUM = "S6"
TITLE = ("Cardiovascular-disease-specific mortality by MD-COPD diagnostic category under both frameworks")
