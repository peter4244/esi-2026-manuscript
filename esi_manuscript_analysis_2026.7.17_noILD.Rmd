...
# Headless-safe raster device: without X11 the default bitmap device is Xlib,
# which cannot open a connection, so png() fails with a warning rather than an
# error and the run appears to succeed while producing no figure. cairo needs
# no display.
